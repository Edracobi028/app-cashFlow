...
//igual auna computada que recibe como argumento una funcion
const isNegative = computed(() => amount.value < 0);

const emit = defineEmits(["remove"]); //emitir el evento remove

//valor emitido desde movement y lo recibe quien use este componente
const remove = () => {
